    ...
    var body: some View {
        NavigationView {
            ...
            .navigationBarItems(leading: Button("Cancel"){
                    ...
                    if (typeSelection == EntityType.Item) {
                        parent.items.append(Item(id: nil, name: name, note: note, imgName: imageName, parent: parent))
                    } else {
                        parent.areas.append(Area(id: nil, name: name, imgName: imageName, parent: parent))
                    }
